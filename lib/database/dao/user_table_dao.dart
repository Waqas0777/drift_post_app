...
class UsersTableDao extends DatabaseAccessor<AppDatabase> with _$UsersTableDaoMixin {
  ...
  Stream<List<UserRegistrationTableData>> get getUsers => select(userRegistrationTable).watch();
  ...
  Future<UserRegistrationTableData> loginByEmailPassword (
    ...
    return await (select(userRegistrationTable)..where((tbl) => tbl.userEmail.equals(email) & tbl.userPassword.equals(password))).getSingle();
