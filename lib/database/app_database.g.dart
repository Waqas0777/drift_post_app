...
class $PostTableTable extends PostTable
  ...
  List<GeneratedColumn> get $columns =>
      [postId, postName, postDescription, userEmail, thumbnailImg];
...
class PostTableData extends DataClass implements Insertable<PostTableData> {
  ...
  @override
  int get hashCode => Object.hash(postId, postName, postDescription, userEmail,
      $driftBlobEquality.hash(thumbnailImg));
